...
export function setupGround() {
  ...
  setCustomProperty(groundElems[1], "--left", 290); //we have our width at 300% so 300 is what we set our starting value as for the second ground piece (-10 a couple pixels so frames dont split)
}
...
// }
  ...
  groundElems.forEach((ground) => {
    ...
    if (getCustomProperty(ground, "--left") <= -300)
      incrementCustomProperty(ground, "--left", 590); // width x 2, frames split if its an even 600
  });
}
